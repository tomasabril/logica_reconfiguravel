...
SIGNAL \lado_dire[0]~feeder_combout\ : std_logic;
...
SIGNAL \ALT_INV_saida0~1_combout\ : std_logic;
...
\ALT_INV_saida0~1_combout\ <= NOT \saida0~1_combout\;
...
-- Equation(s):
-- \process_0~0_combout\ = (!lado_esq(0) & !\bot_raw_1~input_o\)
...
\lado_dire[0]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \lado_dire[0]~feeder_combout\ = \process_0~0_combout\
...
PORT MAP (
	...
	combout => \lado_dire[0]~feeder_combout\);
...
-- Equation(s):
-- \counter[31]~1_combout\ = (lado_dire(0) & (\state.init~q\ & (!\bot_raw_2~input_o\ & !\state.G~q\)))
...
-- Equation(s):
-- \counter[31]~2_combout\ = (\state.R~q\ & ((\counter[31]~1_combout\) # ((!lado_esq(0) & !\bot_raw_1~input_o\))))
...
-- Equation(s):
-- \Selector6~0_combout\ = (\Add0~58_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector35~0_combout\ = (\Add0~0_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector34~0_combout\ = (\Add0~2_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector33~0_combout\ = (\Add0~4_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector32~0_combout\ = (\Add0~6_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector31~0_combout\ = (\Add0~8_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector30~0_combout\ = (\Add0~10_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector29~0_combout\ = (\Add0~12_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector28~0_combout\ = (\Add0~14_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector27~0_combout\ = (\Add0~16_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector26~0_combout\ = (\Add0~18_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector25~0_combout\ = (\Add0~20_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector24~0_combout\ = (\Add0~22_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector23~0_combout\ = (\Add0~24_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector22~0_combout\ = (\Add0~26_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector21~0_combout\ = (\Add0~28_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector20~0_combout\ = (\Add0~30_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector19~0_combout\ = (\Add0~32_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector17~0_combout\ = (\Add0~36_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector16~0_combout\ = (\Add0~38_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector15~0_combout\ = (\Add0~40_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector14~0_combout\ = (\Add0~42_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector13~0_combout\ = (\Add0~44_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector12~0_combout\ = (\Add0~46_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector11~0_combout\ = (\Add0~48_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector9~0_combout\ = (\Add0~52_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector8~0_combout\ = (\Add0~54_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector7~0_combout\ = (\Add0~56_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \Selector5~0_combout\ = (\Add0~60_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (!\Add0~58_combout\ & (!\Add0~56_combout\ & (!\Add0~54_combout\ & !\Add0~60_combout\)))
...
-- Equation(s):
-- \Selector4~0_combout\ = (\Add0~62_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = ((!\Add0~52_combout\) # (!\Add0~50_combout\)) # (!\Add0~48_combout\)
...
-- Equation(s):
-- \LessThan0~2_combout\ = (!\Add0~24_combout\ & (((!\Add0~22_combout\) # (!\Add0~20_combout\)) # (!\Add0~18_combout\)))
...
-- Equation(s):
-- \LessThan0~3_combout\ = (!\Add0~28_combout\ & (!\Add0~30_combout\ & (!\Add0~26_combout\ & \LessThan0~2_combout\)))
...
-- Equation(s):
-- \LessThan0~4_combout\ = (\Add0~34_combout\ & (\Add0~32_combout\ & (\Add0~36_combout\ & !\LessThan0~3_combout\)))
...
-- Equation(s):
-- \LessThan0~5_combout\ = ((!\Add0~38_combout\ & (!\Add0~40_combout\ & !\LessThan0~4_combout\))) # (!\Add0~42_combout\)
...
-- Equation(s):
-- \LessThan0~6_combout\ = (\LessThan0~1_combout\) # ((!\Add0~46_combout\ & (!\Add0~44_combout\ & \LessThan0~5_combout\)))
...
-- Equation(s):
-- \Selector2~3_combout\ = ((\Add0~62_combout\) # ((\LessThan0~0_combout\ & \LessThan0~6_combout\))) # (!\state.G~q\)
...
-- Equation(s):
-- \Selector10~0_combout\ = (\Add0~50_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \LessThan1~9_combout\ = (!\Add0~56_combout\ & (!\Add0~52_combout\ & !\Add0~54_combout\))
...
-- Equation(s):
-- \LessThan1~10_combout\ = (\Add0~62_combout\) # ((!\Add0~58_combout\ & (!\Add0~60_combout\ & \LessThan1~9_combout\)))
...
-- Equation(s):
-- \LessThan1~11_combout\ = (\LessThan1~10_combout\) # ((!\Add0~50_combout\ & (\LessThan0~0_combout\ & \LessThan1~7_combout\)))
...
-- Equation(s):
-- \counter[31]~3_combout\ = (\counter[31]~2_combout\) # ((\counter[31]~0_combout\ & (\state.init~q\ & !\LessThan1~11_combout\)))
...
-- Equation(s):
-- \Selector18~0_combout\ = (\Add0~34_combout\ & (!\counter[31]~3_combout\ & ((\Selector2~3_combout\) # (!\state.init~q\))))
...
-- Equation(s):
-- \LessThan1~5_combout\ = (!\Add0~16_combout\ & (!\Add0~20_combout\ & (!\Add0~18_combout\ & !\Add0~22_combout\)))
...
-- Equation(s):
-- \LessThan1~4_combout\ = (((!\Add0~30_combout\) # (!\Add0~32_combout\)) # (!\Add0~28_combout\)) # (!\Add0~26_combout\)
...
-- Equation(s):
-- \LessThan1~6_combout\ = (\LessThan1~4_combout\) # ((\LessThan1~5_combout\ & !\Add0~24_combout\))
...
-- Equation(s):
-- \LessThan1~2_combout\ = (((!\Add0~38_combout\ & !\Add0~36_combout\)) # (!\Add0~42_combout\)) # (!\Add0~40_combout\)
...
-- Equation(s):
-- \LessThan1~3_combout\ = (((\LessThan1~2_combout\) # (!\Add0~46_combout\)) # (!\Add0~44_combout\)) # (!\Add0~48_combout\)
...
-- Equation(s):
-- \LessThan1~7_combout\ = (\LessThan1~3_combout\) # ((!\Add0~34_combout\ & (!\Add0~38_combout\ & \LessThan1~6_combout\)))
...
-- Equation(s):
-- \Selector2~4_combout\ = (\state.init~q\ & (!\Selector2~2_combout\ & \Selector2~3_combout\))
...
-- Equation(s):
-- \Selector2~5_combout\ = (!\Selector2~0_combout\ & ((\Selector2~4_combout\ & ((\state.Y~q\))) # (!\Selector2~4_combout\ & (!\Selector2~3_combout\))))
...
-- Equation(s):
-- \LessThan1~8_combout\ = (!\Add0~50_combout\ & \LessThan0~0_combout\)
...
-- Equation(s):
-- \Selector2~2_combout\ = (\state.Y~q\ & (!\LessThan1~10_combout\ & ((!\LessThan1~8_combout\) # (!\LessThan1~7_combout\))))
...
-- Equation(s):
-- \Selector3~0_combout\ = (!\Selector2~0_combout\ & ((\Selector2~4_combout\ & ((\state.R~q\))) # (!\Selector2~4_combout\ & (\Selector2~2_combout\))))
...
-- Equation(s):
-- \Selector2~1_combout\ = (\Add0~62_combout\) # (!\state.G~q\)
...
-- Equation(s):
-- \Selector1~0_combout\ = (!\Selector2~2_combout\ & ((\Selector2~1_combout\) # ((\LessThan0~0_combout\ & \LessThan0~6_combout\))))
...
-- Equation(s):
-- \Selector1~1_combout\ = (\Selector2~0_combout\) # ((\Selector1~0_combout\ & ((\state.G~q\) # (!\state.init~q\))))
...
-- Equation(s):
-- \counter[31]~0_combout\ = (!\state.G~q\ & !\state.R~q\)
...
-- Equation(s):
-- \current[0]~0_combout\ = current(0) $ (\Selector2~0_combout\)
...
-- Equation(s):
-- \leds~2_combout\ = (\state.G~q\ & (!current(0))) # (!\state.G~q\ & (current(0) & \state.R~q\))
...
-- Equation(s):
-- \leds~3_combout\ = (\leds~2_combout\) # ((\counter[31]~0_combout\ & (!\state.Y~q\ & \state.init~q\)))
...
-- Equation(s):
-- \leds~4_combout\ = (\state.Y~q\ & current(0))
...
-- Equation(s):
-- \leds~5_combout\ = (\leds~2_combout\) # ((\counter[31]~0_combout\ & (!\leds~4_combout\ & !\state.init~q\)))
...
-- Equation(s):
-- \leds~6_combout\ = (\state.Y~q\ & !current(0))
...
-- Equation(s):
-- \leds~8_combout\ = (\state.Y~q\ & (((!current(0))))) # (!\state.Y~q\ & ((current(0) & (\state.R~q\ & !\state.G~q\)) # (!current(0) & ((\state.G~q\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0000111100101100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \state.R~q\,
...
-- Equation(s):
-- \saida0~1_combout\ = (\state.G~q\) # ((\state.Y~q\) # (!\state.R~q\))
