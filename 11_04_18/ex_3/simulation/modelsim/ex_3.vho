...
-- pragma translate_on
PORT MAP (
	dataa => \entrada_padrao[2]~input_o\,
...
-- Equation(s):
-- \busca[4][2]~combout\ = \entrada_busca[6]~input_o\ $ (\entrada_padrao[2]~input_o\)
...
-- Equation(s):
-- \WideAnd0~0_combout\ = (\entrada_padrao[0]~input_o\ & (\entrada_busca[0]~input_o\ & (\entrada_busca[1]~input_o\ $ (!\entrada_padrao[1]~input_o\)))) # (!\entrada_padrao[0]~input_o\ & (!\entrada_busca[0]~input_o\ & (\entrada_busca[1]~input_o\ $ 
-- (!\entrada_padrao[1]~input_o\))))
...
-- Equation(s):
-- \WideAnd4~0_combout\ = (\entrada_padrao[0]~input_o\ & (\entrada_busca[4]~input_o\ & (\entrada_padrao[1]~input_o\ $ (!\entrada_busca[5]~input_o\)))) # (!\entrada_padrao[0]~input_o\ & (!\entrada_busca[4]~input_o\ & (\entrada_padrao[1]~input_o\ $ 
-- (!\entrada_busca[5]~input_o\))))
...
PORT MAP (
	dataa => \entrada_padrao[0]~input_o\,
	datab => \entrada_padrao[1]~input_o\,
	datac => \entrada_busca[4]~input_o\,
